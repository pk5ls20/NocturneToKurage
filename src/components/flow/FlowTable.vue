...
const headers = ref<Header[]>([
  ...
  { title: 'Client', align: 'start', key: 'clientName' },
...
const data = ref<OidbData[]>([
  { time: '2024-09-01 19:34:00', seq: 1, cmd: 'OidbSvcTrpcTcp.0xd1145_14', data: '114514', clientName: 'Client 1' },
  { time: '2024-09-01 19:34:01', seq: 2, cmd: 'OidbSvcTrpcTcp.0xd1919_81', data: '114514', clientName: 'Client 2' },
]);
