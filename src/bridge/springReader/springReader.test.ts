...
test('springReader1', () => {
  ...
  const reader = new SpringReader(Buffer.from("ffffffffffffffffffffffffffffff0001bf52001d4b4244417a9f80800080000000800000000000000048656c6c6f2c20776f726c6421086578616d706c650011416e6f74686572206578616d706c6500030001000656616c7565310002000656616c7565320003000656616c756533", "hex"));
...
test('springReader2', () => {
  const reader = new SpringReader(Buffer.from("", "hex"));
  ...
  expect(data).deep.equal(new Uint8Array(Buffer.from("", "hex")));
})
